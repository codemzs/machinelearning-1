...
[assembly: LoadableClass(GenerateRowsTransform.Summary, typeof(GenerateRowsTransform), typeof(GenerateRowsTransform.Options), typeof(SignatureDataTransform),
    GenerateRowsTransform.UserName, GenerateRowsTransform.LoadName, "GenerateNumber", GenerateRowsTransform.ShortName)]

[assembly: LoadableClass(GenerateRowsTransform.Summary, typeof(GenerateRowsTransform), null, typeof(SignatureLoadDataTransform),
    GenerateRowsTransform.UserName, GenerateRowsTransform.LoaderSignature)]
...
namespace Microsoft.ML.Transforms
{
    ...
    /// </summary>
    [BestFriend]
    internal sealed class GenerateRowsTransform : RowToRowTransformBase
    {
        ...
        public const string LoadName = "GenerateRowsTransform";
        ...
        private static VersionInfo GetVersionInfo()
        {
            return new VersionInfo(
                ...
                loaderAssemblyName: typeof(GenerateRowsTransform).Assembly.FullName);
        }
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="GenerateRowsTransform"/>.
        /// </summary>
        ...
        public GenerateRowsTransform(IHostEnvironment env, IDataView input, string name, uint? seed = null, bool useCounter = Defaults.UseCounter)
        ...
        /// </summary>
        public GenerateRowsTransform(IHostEnvironment env, Options options, IDataView input)
        ...
        private GenerateRowsTransform(IHost host, ModelLoadContext ctx, IDataView input)
            : base(host, input)
        {
        ...
        public static GenerateRowsTransform Create(IHostEnvironment env, ModelLoadContext ctx, IDataView input)
        {
            ...
            return h.Apply("Loading Model", ch => new GenerateRowsTransform(h, ctx, input));
        }
        ...
        private sealed class Cursor : SynchronizedCursorBase
        {
            ...
            public override bool MoveNext()
            {
                if (_generateNewRow)
                {
                    _generateNewRow = false;
                    return true;
                }
                else
                    _generateNewRow = true;
